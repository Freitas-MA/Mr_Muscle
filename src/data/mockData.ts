    ...
    "modalities": [
      {
        "id": 1,
        "name": "Musculação",
        "description": "Treinamento personalizado para ganho de massa muscular e força",
      ...
      },
      {
        "id": 2,
        "name": "CrossFit",
        "description": "Treinos funcionais de alta intensidade para melhorar condicionamento geral",
